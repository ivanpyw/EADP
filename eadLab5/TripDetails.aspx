        ...
        <div class="row">
            <div class="col-md-4">
                <div class="text-center trip-panels">
                    ...
                    <div class="trip-text">
                        ...
                        <p>Expected cost: $<%= tripObj[0].tripCost %></p>
                    </div>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tripModal<%= tripObj[0].tripId+3 %>">
                        View details
                    </button>
                </div>
            </div>
            <div class="modal fade" id="tripModal<%=tripObj[0].tripId+3 %>" tabindex="-1" role="dialog" aria-labelledby="tripModal<%=tripObj[0].tripId+3 %>" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="text-center modal-title"><%=tripObj[0].tripTitle %></h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <p>Frequency and duration: <%= tripObj[0].tripStart.ToString("MM/dd/yy") %> to <%=tripObj[0].tripEnd.ToString("MM/dd/yy") %></p>
                            <p>Duration: <%=tripObj[0].tripDays %></p>
                            <p>Activities: <%=tripObj[0].tripActivities %></p>
                            <p>Estimated cost: <%=tripObj[0].tripCost %></p>
                        </div>
