...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        Feedbacks for this student to do<asp:GridView ID="GridViewStudentFeedBack" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridViewStudentFeedBack_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None" Style="margin: 0 auto;">
